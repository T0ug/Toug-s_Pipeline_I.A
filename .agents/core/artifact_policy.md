...
docs/tasks.md is a Category B artifact (controlled mutable).

It must:

- be updated by the Orchestrator
- reflect the real state of the project
- be consistent with project_status.md

---

Internal task artifacts generated by the model:

- are not authoritative
- must not be treated as persistent planning
- must not replace docs/tasks.md
...
docs/tasks.md must represent the real execution state of the project.
